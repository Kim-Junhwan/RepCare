...
final class ImageFetcher {
    ...
    func fetchImage(id: String, imagePath: String, completion: @escaping ((Result<UIImage, Error>)-> Void)) {
    ...
    private func registerNewFetchImageOperation(id: String, imagePath: String, completion: @escaping ((Result<UIImage, Error>)-> Void)) {
